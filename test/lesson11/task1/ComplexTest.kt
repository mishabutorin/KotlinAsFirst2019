...
internal class ComplexTest {
    ...
    @Test
    fun minus() {
        assertApproxEquals(Complex("1+6i"), Complex("4+2i") - Complex("3-4i"), 1e-10)
    }
    ...
    @Test
    fun div() {
        assertApproxEquals(Complex("2.230769230769231+0.15384615384615385i"), Complex("7-4i") / Complex("3-2i"), 1e-10)
    }
